-- CREATE TEMP Table (this is source table we are referencing)
...
-- SET 
--     priority_lvl = src.priority_lvl, -- don't alias tgt.
--     updated_at = src.updated_at
-- FROM
--     src_priority_jobs AS src
-- WHERE
--     tgt.job_id = src.job_id
--     AND tgt.priority_lvl IS DISTINCT FROM src.priority_lvl; -- checks row by row if it actually changes
